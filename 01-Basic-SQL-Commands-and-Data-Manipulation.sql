...
-- 2. SORU: Belirli bir ulke kriterine göre maaslarda %10 oraninda UPDATE islemi.
UPDATE PERSONEL 
SET maas = maas * 1.10 
WHERE ulke = 'Turkiye';
...
-- 5-6. SORU: BETWEEN ve IN operatörleri ile belirli araliklarda veri filtreleme.
SELECT * FROM PERSONEL 
...
-- 16-20. SORU: GROUP BY ve HAVING yapilari kullanilarak ülke ve cinsiyet bazli gelismis raporlama.
